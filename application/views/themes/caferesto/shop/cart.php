...
<div class="hero-wrap hero-bread" style="background-image: url('<?php echo get_theme_uri('images/fu_3.png'); ?>');">
    <div class="container">
      <div class="row no-gutters slider-text align-items-center justify-content-center">
        <div class="col-md-9 ftco-animate text-center">
            <p class="breadcrumbs"><span class="mr-2"><?php echo anchor(base_url(), 'Home'); ?></span> <span>Keranjang</span></p>
  ...
  <section class="ftco-section ftco-Keranjang Belanja">
          ...
          <?php else : ?>
            <div class="row">
              <div class="col-md-12 ftco-animate">
                <div class="alert alert-info">Tidak ada makanan atau minuman dalam keranjang.<br><?php echo anchor('#products', 'Lihat menu kami'); ?>!</div>
              </div>
            </div>
          <?php endif; ?>
          </div>
