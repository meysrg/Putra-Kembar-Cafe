...
<html lang="en">
  ...
  <body class="goto-here">
    ...
    <nav class="navbar navbar-expand-lg navbar-light ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
		...
		<img src="<?php echo base_url('assets/uploads/sites/Logo1.png'); ?>" height='50' width='70' >
		
		<?php echo get_store_name(); ?></a>
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
			  ...
			  <li class="nav-item"><a href="<?php echo site_url('#products'); ?>" class="nav-link">Menu</a></li>
	        ...
	        <li class="nav-item"><a href="<?php echo site_url('shop/cart'); ?>" class="nav-link"><span class="icon-shopping_cart">Keranjang </span>[<span class="cart-item-total">0</span>]</a></li>
