      ...
      <div class="row mb-5">
        <div class="col-md">
          <div class="ftco-footer-widget mb-4">
            ...
            <span class="icon icon-map-marker"></span>&nbsp&nbsp&nbsp<span class="text"><?php echo get_settings('store_address'); ?></&span></li>
          </div>
        </div>
        <div class="col-md">
          <div class="ftco-footer-widget mb-4 ml-md-5">
            ...
            <ul class="list-unstyled">
              ...
              <li><a href="#testimoni" class="py-2 d-block">Testimoni Pelanggan</a></li>
            </ul> 
          </div>
        </div>
        <div class="col-md-3">
          ...
          <div class="ftco-footer-widget mb-4">
              ...
              <div class="block-23 mb-3">
                <ul>
                  ...
                  <li><a href="https://instagram.com/cafe.resto_putrakembar?igshid=YmMyMTA2M2Y="><span class="icon icon-instagram"></span><span class="text"> @cafe.resto_putrakembar</span></a></li>
                  <li><a href="https://www.facebook.com/putrakembarresto.caffe"><span class="icon icon-facebook"></span><span class="text"> Putra Kembar Resto Caffe</span></a></li>
                  <li><a href="#"><span class="icon icon-envelope"></span>&nbsp&nbsp&nbsp<span class="text"><?php echo get_settings('store_email'); ?></span></a></li>
                </ul>
              </div>
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-md-12 text-center">
          <p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                        Copyright &copy;<script>document.write(new Date().getFullYear());</script> Putra Kembar Coffee Shop & Resto
