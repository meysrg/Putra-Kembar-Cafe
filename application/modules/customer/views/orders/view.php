            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"><?php echo anchor('customer/orders', 'Pesanan'); ?></li>
                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body p-0">
                        <?php if ($data->payment_price == NULL) : ?>
                            <div class="alert alert-light m-2"><b>Tidak ada data pembayaran.</b></div>
                        <?php else : ?>
                            <table class="table table-hover table-striped table-hover">
                                <tr>
                                    <td>Transfer</td>
                        ...
                        <div class="text-center actionRow">
                            <?php if ($data->payment_method == 1) : ?>
                                <?php if ($data->order_status == 1) : ?>
                                    ...
                                    <b><font color="green">Pesanan Menunggu Pembayaran</font></b></div>
                                    <h6>Silahkan Lakukan Pembayaran <font color="red">Sesuai dengan Harga Pesanan Anda.</font>
                                    <br>Transfer Kepada:</h6>
                                    <h5><font color="blue">Bank SUMUT - 22302040002578</font> <br>(Herlina Butar butar) </h5><br>
   
                                    <a href="<?php echo site_url('customer/payments/confirm?order='. $data->id); ?>" class="btn btn-success">Upload Bukti Pembayaran</a>
                                    <br><br>
                                    <a href="#" class="btn btn-danger" data-toggle="modal" data-target="#cancelModal">Batalkan Pesanan</a>
                                <?php elseif ($data->order_status == 5) : ?>
                                    <p><b><font color="red">Pesanan Dibatalkan</font></b></p>
                                ...
                                <?php elseif ($data->order_status == 2) : ?>
                                    <p><b><font color="orange">Pesanan Dalam Proses</font></b></p>
                                <?php elseif ($data->order_status == 3) : ?>
                                    <p><b><font color="orange">Dalam Pengiriman</font></b></p>
                                <?php elseif ($data->order_status == 4) : ?>
                                    <p><b><font color="green">Pesanan Selesai</font></b></p>
                                    <a href="#" class="btn btn-warning" data-toggle="modal" data-target="#deleteModal"><i class="fa fa-trash"></i> Hapus</a>
                                <?php endif; ?>
                            <?php elseif ($data->payment_method == 2) : ?>
                                <?php if ($data->order_status == 1) : ?>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Anda yakin ingin membatalkan pesanan? Silahkan hubungi kami untuk pengembalian dana.</p>
                </div>
