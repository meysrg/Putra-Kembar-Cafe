...
class Products extends CI_Controller {
    ...
    {
        $params['title'] = 'Kelola Menu '. get_store_name();
    ...
    public function add_product()
    {
        ...
        $this->form_validation->set_rules('name', 'Nama Menu', 'trim|required|min_length[4]|max_length[255]');
        $this->form_validation->set_rules('price', 'Harga Menu', 'trim|required');
        $this->form_validation->set_rules('description', 'Deskripsi Menu', 'max_length[512]');
        $this->form_validation->set_rules('picture_name', 'Foto', 'max_length[512]');
        ...
        else
        {
            ...
            $code = create_product_code($name, $category_name, $price);
            ...
            $this->session->set_flashdata('add_new_product_flash', 'Menu baru berhasil ditambahkan!');
