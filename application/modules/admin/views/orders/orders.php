                ...
                <tbody>
                  <?php foreach ($orders as $order) : ?>
                    <tr>
                      ...
                      <a href="<?php echo site_url('admin/orders/view/'. $order->id); ?>"><i class="fa fa-eye text-blue"></i>&nbsp&nbsp</a><?php echo anchor('admin/orders/view/'. $order->id,  $order->order_number); ?>
                      </th>
                      <td class="text-center"><?php echo $order->customer; ?></td>
                      ...
                      <td class="text-center"><?php echo get_order_status($order->order_status, $order->payment_method); ?></td>
                    </tr>
                  <?php endforeach; ?>
                </tbody>
              </table>
