      ...
      <div class="row">
          ...
          <div class="card-wrapper">
            <div class="card">
              ...
              <table class="table align-items-center table-flush table-hover">
                    <tr>
                      <td>Kode Pesanan</td>
                      <td><b><?php echo $payment->order_number; ?></b></td>
                    </tr>
                    <tr>
                        <td>Transfer</td>
        ...
        <div class="col-md-4">
            <div class="card card-primary">
              ...
              <div class="card-body p-0">
                <a href="<?php echo base_url('assets/uploads/payments/'. $payment->picture_name); ?>" class="image-popup"><img src="<?php echo base_url('assets/uploads/payments/'. $payment->picture_name); ?>" class="img-fluid" alt="<?php echo $payment->order_number; ?>"></a>
              </div>
