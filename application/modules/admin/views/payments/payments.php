                ...
                <tbody>
                  <?php foreach ($payments as $payment) : ?>
                    <tr>
                      ...
                      <a href="<?php echo site_url('admin/payments/view/' . $payment->id); ?>"><i class="fa fa-eye text-blue"></i></a>&nbsp&nbsp<?php echo anchor('admin/payments/view/' . $payment->id,  $payment->order_number); ?>
                      </th>
                      ...
                      <td class="text-center"><?php echo get_payment_status($payment->status); ?></td>
                    </tr>
                  <?php endforeach; ?>
                </tbody>
              </table>
