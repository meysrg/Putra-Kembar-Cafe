...
<head>
  ...
  <!-- Favicon -->
  <link rel="icon" href="<?php echo get_theme_uri('img/brand/admin.png', 'argon'); ?>" type="image/png">
  <!-- Fonts -->
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="<?php echo site_url('admin/products/coupons'); ?>">
                <i class="fa fa-money-bill-wave-alt text-warning"></i>
            ...
            <?php else : ?>
              ...
              <div class="form-group mb-0">
                <div class="input-group input-group-alternative input-group-merge">
                  ...
                  <input class="form-control" value="<?php echo (isset($query) ? $query : ''); ?>" name="search_query" placeholder="Cari Menu..." type="text" required>
                </div>
              </div>
