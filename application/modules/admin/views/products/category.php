        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            <div class="col-lg-6 col-7">
              <h6 class="h2 text-white d-inline-block mb-0">Kategori Menu</h6>
            </div>
        ...
        <div class="col">
          <div class="card">
            ...
            <div class="card-header border-0">
              <h3 class="mb-0">Kelola Kategori Menu</h3>
              <div class="col-lg-12 col-5 text-right">
              <a href="#" data-target="#addModal" data-toggle="modal" class="btn btn-primary">Tambah</a>
            </div>
            </div>
                      ...
                      <form role="form" action="#" method="POST" id="addCategoryForm">
                          ...
                          <div class="form-group mb-3">
                              <div class="input-group input-group-merge input-group-alternative">
                                  ...
                                  <input name="name" class="form-control" placeholder="Nama " type="text" minlength="3" maxlength="255" required>
                                </div>
                        ...
                        <input type="hidden" name="id" value="" class="edit-id">
                          ...
                          <div class="form-group mb-3">
                              <div class="input-group input-group-merge input-group-alternative">
                                  ...
                                  <input name="name" class="form-control edit-name" placeholder="Nama kategori" type="text" minlength="3" maxlength="100" required>
                                </div>
                                <div class="text-danger err name-error"></div>
                          </div>
