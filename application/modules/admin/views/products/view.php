          ...
          <div class="row align-items-center py-4">
            ...
            <div class="col-lg-6 col-5 text-right">
                ...
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                  ...
                  <li class="breadcrumb-item"><a href="<?php echo site_url('admin/products'); ?>">Menu</a></li>
    ...
    <div class="container-fluid mt--6">
              ...
              <div>
                ...
                <table class="table table-hover table-striped">
                    ...
                    <tr>
                        ...
                        <td>:</td>
                        <td>
                          <?php echo ($product->is_available == 1) ? '<b class="text-blue">Tersedia</b>' : '<b class="text-danger">Tidak</b>'; ?>
                        </td>
                    </tr>
                </table>
              </div>
            ...
            <div class="card card-primary">
              ...
              <table class="table align-items-center table-flush">
                ...
                <?php foreach ($orders as $order) : ?>
                  <tr>
                    <th scope="col">
                    <a href="<?php echo site_url('admin/orders/view/'. $order->order_id); ?>"><i class="fa fa-eye text-blue"></i></a>&nbsp&nbsp<?php echo anchor('admin/orders/view/'. $order->order_id,  $order->order_number); ?></td>
                    <th>
                      <?php echo $order->name; ?>
                    </th>
      ...
      <div class="modal-content">
          <div class="modal-header">
              <h6 class="modal-title" id="modal-title-default">Hapus Menu</h6>
          ...
          <div class="modal-body">
              <p class="deleteText">Yakin ingin menghapus menu ini? Semua data yang terkait seperti data order juga akan dihapus. Tindakan ini tidak dapat dibatalkan.</p>
          </div>
                ...
                if (res.code == 204) {
                    setTimeout(function() {
                        ...
                        $('.deleteText').fadeOut(function() {
                            $(this).text('Menu berhasil dihapus')
                        }).fadeIn();
                    }, 2000);
                    ...
                    console.log('Terjadi kesalahan sata menghapus menu');
                }
            }
        })
    })
