        ...
        <div class="col">
          <div class="card">
            ...
            <div class="card-header">
              ...
              <a href="<?php echo site_url('admin/products/add_new_product'); ?>" class="btn btn-primary">Tambah</a>
            </div>
            </div>
                    ...
                    <div class="col-md-3">
                        <div class="card card-primary">
                            ...
                            <div class="card-footer text-center">
                                ...
                                <a href="<?php echo site_url('admin/products/edit/'. $product->id); ?>" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>
                              </div>
            ...
            <?php else : ?>
             <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <a href="<?php echo site_url('admin/products/add_new_product'); ?>"><i class="fa fa-plus"></i> Tambah menu baru</a>
                        <br>
